...
public class TenantOptions extends JPanel implements ActionListener {
	...
	public TenantOptions(ManagePane mp) {
		...
		add(lblBereitstellungskosten, "cell 0 7,alignx right,aligny center");
		bereitstellungsKosten = new JFormattedTextField(NumberFormat.getNumberInstance());
		bereitstellungsKosten.setColumns(15);
		add(bereitstellungsKosten, "cell 1 7,alignx left,aligny center");
		...
		add(bereitstellungsDatum, "cell 2 7,alignx left,aligny center");
		...
		add(lblVerteilerkosten, "cell 0 8,alignx right,aligny center");
		verteilerKosten = new JFormattedTextField(NumberFormat.getNumberInstance());
		verteilerKosten.setColumns(15);
		add(verteilerKosten, "cell 1 8,alignx left,aligny center");
		...
		add(verteilerDatum, "cell 2 8,alignx left,aligny center");
		...
		add(btnSpeichern, "cell 1 9,alignx left,aligny center");
		add(btnNeuerMieter, "cell 1 10,alignx left,aligny center");
		clear();
	...
	if(changed(verteilerDatum) || changed(verteilerKosten)) {
		TenantInput.setCableSupplyCost(parent.getTenant(), textToDouble(verteilerKosten.getText()), (Date) verteilerDatum.getValue());
	}
	
	if(changed(bereitstellungsDatum) || changed(bereitstellungsKosten)) {
		TenantInput.setCableProvidingCost(parent.getTenant(), textToDouble(bereitstellungsKosten.getText()), (Date) bereitstellungsDatum.getValue());
	}
