...
public class DbHandle {
    ...
    /**
     * Opens a database for use of all mayor actions (only one db can be
     * declared as main db) This needs to be the database including all
     * important information about tenants, flats and so on
     * 
     * @param path
    ...
    /**
     * Finds all entrys that contain the given value in the given column. Sorted
     * by date if available.
     * 
     * @param tbl
     * @param column
     * @param value
     * @return a list of rows who contain the searched value (empty if nothing
     *         was found)
     */
