...
public class Tenant implements DbNames, Comparable<Tenant>, LoadAble {
    ...
    /**
     * Find the date a tenant moved out, if no date exists the date is set to
    ...
    /**
     * 
     * @return the date of blance last read from the db, null if none was read
     *         yet
     */
    ...
    /**
     * returns amount of month garages were rented, can be > 12 if multiple
     * garages were rented
     * 
     * @param year
     * @return
